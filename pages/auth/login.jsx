        ...
        <div className="w-full bg-white text-black rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 ">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6" action="#">
              ...
              <FacebookLoginButton onClick={() => alert("Sign in")} />
              <GithubLoginButton onClick={() => alert("Sign in")} />
             <LinkedInLoginButton onClick={() => alert("Sign in")} />
              <GoogleLoginButton onClick={() => alert('Sign in')} />
